  ...
  <div class="container px-6 mx-auto grid">
            ...
            <tr class="text-gray-700 dark:text-gray-400">
              <td class="px-4 py-3">
                <div class="flex items-center text-sm">
                  <div class="relative hidden w-16 h-16 mr-3 rounded md:block">
              ...
              <td class="px-4 py-3 text-sm">
                <div class="custom-number-input h-8 w-32">
                  <div class="flex flex-row h-8 w-full rounded relative bg-transparent mt-1">
                    ...
                    <input type="number" class="border-gray-100 outline-none focus:outline-none text-center w-full bg-white font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center text-gray-700  outline-none" name="custom-input-number" value="0"></input>
              ...
              <td class="px-4 py-3 text-sm text-red-400">
                <button class="bg-red-200 text-red-600 hover:text-white hover:bg-red-600 h-8 w-16 rounded cursor-pointer">
                  <a href="#">
    ...
    <div class="my-6 p-6 mb-8 bg-white rounded-lg shadow-md focus:outline-none focus:shadow-outline-sp-primary">
      <div class="flex flex-row justify-end">
        <button class="bg-sp-primary-200 text-white hover:text-white hover:bg-sp-primary-400 h-12 w-full rounded cursor-pointer">
          <a href="#">
            Beli Sekarang
          </a>
        </button>
