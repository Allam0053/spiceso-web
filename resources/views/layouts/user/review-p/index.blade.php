<x-user-in-layout>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="relative z-10 flex items-baseline justify-between pt-10 pb-8 border-b border-gray-200">
      <h1 class="text-4xl font-bold tracking-tight text-gray-900">Review Produk</h1>
    </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-4"> 
        ...
        <form class="bg-white py-12 px-6 rounded lg:col-span-3">
          ...
          <label class="block mt-3 text-sm">
            <span class="text-gray-700 dark:text-gray-400 mb-1">Bagaimana kualitas produk ini secara keseluruhan?</span>
            <ul class="flex justify-left mt-1">
              <li> <i class="fas fa-star fa-lg text-yellow-500 mr-1"></i> </li> 
              <li> <i class="fas fa-star fa-lg text-yellow-500 mr-1"></i> </li> 
              <li> <i class="fas fa-star fa-lg text-yellow-500 mr-1"></i> </li>
              <li> <i class="far fa-star fa-lg text-yellow-500 mr-1"></i> </li>
              <li> <i class="far fa-star fa-lg text-yellow-500 mr-1"></i> </li>
            </ul>
          </label>

          <label class="block mt-3 text-sm">
            <span class="text-gray-700 dark:text-gray-400 font-bold">Ulasan</span>
              <textarea
              ...
              <div class="space-y-1 text-center" id="photo-input-field">
                  ...
                  <div class="flex text-sm text-gray-600">
                      <label for="foto"
                          ...
                          <span>Tambahkan Foto Review</span>
          ...
          <button type="submit" class="mt-10 w-full bg-sp-primary-200 focus:bg-sp-primary-400 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-sp-primary-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sp-primary-100">Review</button>
        </form>
