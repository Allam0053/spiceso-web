            ...
            <div class="container px-6 mx-auto grid">
                ...
                <form class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800" method="POST">
                    ...
                    <label class="block mt-4  text-sm">
                        ...
                        <div
                            ...
                            <input
                                ...
                                placeholder="spiceso@example.com" />
                    ...
                    <label class="block  mt-4 text-sm">
                        ...
                        <input
                            class="rounded border-gray-300 block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-sp-primary-100 focus:outline-none focus:shadow-outline-sp-primary dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            placeholder="22/11/2001" type="date" />
                    </label>
                    ...
                    <label class="block mt-4 text-sm">
                        ...
                        <textarea
                            ...
                            rows="3" placeholder="Alamat tujuan pengiriman"></textarea>
                    </label>
