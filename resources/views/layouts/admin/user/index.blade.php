<x-admin-layout>
  <div class="container px-6 mx-auto grid">
    ...
    <!-- CTA -->
    <a class="flex items-center justify-between cursor-default p-4 mb-8 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple"
      href="#">
